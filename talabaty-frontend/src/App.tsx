...
function ProtectedRoute({ children, requireStore = true }: {
...
function AppRoutes() {
    return (<Routes>
      ...
      <Route path="/change-password" element={<ProtectedRoute requireStore={false}>
            <ChangePassword />
          </ProtectedRoute>}/>
      <Route path="/select-store" element={<ProtectedRoute requireStore={false}>
            <SelectStore />
          </ProtectedRoute>}/>
