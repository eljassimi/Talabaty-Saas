...
export default function Layout() {
    ...
    return (<div className="min-h-screen dark:bg-[#222328]" style={isLight ? { backgroundColor: '#FFFFFF' } : undefined} data-layout="saas-dashboard">
      <Sidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)}/>
      <div className="lg:pl-[240px] flex flex-col min-h-screen">
        <Header onMenuClick={() => setSidebarOpen((o) => !o)} storeCount={storeCount}/>
        <main className="flex-1 p-4 lg:p-6 lg:p-8 overflow-auto dark:bg-[#222328]" style={isLight ? { backgroundColor: '#FFFFFF' } : undefined}>
          <Outlet />
        </main>
      </div>
    </div>);
