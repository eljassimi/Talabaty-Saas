                ...
                <div key={index} className="grid grid-cols-12 gap-3 items-end">
                  <div className="col-span-3">
                    ...
                    <input
                      type="text"
                      required
                      value={support.firstName}
                      onChange={(e) => updateSupport(index, 'firstName', e.target.value)}
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    />
                  </div>
                  <div className="col-span-3">
                    ...
                    <input
                      type="text"
                      required
                      value={support.lastName}
                      onChange={(e) => updateSupport(index, 'lastName', e.target.value)}
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    />
                  </div>
                  <div className="col-span-4">
                    ...
                    <input
                      ...
                      required
                      value={support.email}
                      onChange={(e) => updateSupport(index, 'email', e.target.value)}
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    />
                  </div>
                  <div className="col-span-1">
                    ...
                    <input
                      ...
                      onChange={(e) => updateSupport(index, 'password', e.target.value)}
                      placeholder="Auto"
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    />
                  </div>
