  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <a
          href="mailto:support@talabaty.com"
          className="flex items-center gap-4 p-5 rounded-xl border border-[#E6E8EC] bg-white hover:shadow-md transition-shadow"
        >
        ...
        <a
          href="#"
          className="flex items-center gap-4 p-5 rounded-xl border border-[#E6E8EC] bg-white hover:shadow-md transition-shadow sm:col-span-2"
        >
          <div className="h-12 w-12 rounded-xl bg-[#F6F8FB] flex items-center justify-center shrink-0" style={{ color: storeColor }}>
