...
export default function PaymentRequests() {
  ...
  useEffect(() => {
    if (!permissions.canManagePaymentRequests) return
    supportService
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mt-6">
        ...
        <input
          ...
          className="w-full max-w-md rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#222328] px-4 py-2 text-gray-900 dark:text-white"
        />
      </div>
                    ...
                    {r.status === 'PENDING' && (
                      <span className="flex justify-end gap-2">
                        ...
                        <button
                          ...
                          disabled={!!processingId}
                          className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-white text-sm font-medium hover:bg-gray-300 dark:hover:bg-gray-500 disabled:opacity-50"
                        >
