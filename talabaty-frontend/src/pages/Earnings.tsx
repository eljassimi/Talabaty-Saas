...
export default function Earnings() {
  ...
  const handleRequestPayment = async () => {
    if (!storeId || !requestAmount) return
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="mt-8 grid gap-6">
        ...
        <div className="bg-white dark:bg-[#2A2D35] rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3 items-center">
            <input
              ...
              className="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#222328] px-4 py-2 text-gray-900 dark:text-white"
            />
            <button
              onClick={() => setRequestAmount(String(balanceNum))}
            ...
            <button
              ...
              disabled={requesting || balanceNum <= 0}
              className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg font-medium hover:opacity-90 disabled:opacity-50"
            >
        ...
        <div className="bg-white dark:bg-[#2A2D35] rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          {requests.length === 0 ? (
            <p className="mt-4 text-sm text-gray-500">No payment requests yet.</p>
          ) : (
