...
export default function ShippingProviders() {
    ...
    return (<div className="space-y-6">
      ...
      {!stores || stores.length === 0 ? (<div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          {Array.isArray(stores) && stores.map((store) => {
                ...
                return (<div key={store.id} className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                  ...
                  <a href={`/stores/${store.id}`} className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                ...
                <div className="px-6 py-4">
                  {providers.length === 0 ? (<div className="text-center py-8">
                      ...
                      <a href={`/stores/${store.id}`} className="mt-4 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700">
